...
describe('ExpensesForm Component', () => {
  ...
  it('should render form with all required input fields', () => {
    ...
    expect(screen.getByLabelText(/amount/i) || screen.getByPlaceholderText(/amount/i)).toBeInTheDocument();
    expect(screen.getByLabelText(/category/i) || screen.getByPlaceholderText(/category/i)).toBeInTheDocument();
  ...
  it('should render submit button', () => {
    render(<ExpensesForm {...defaultProps} />);
    expect(screen.getByRole('button', { name: /submit|add|save/i })).toBeInTheDocument();
  });
  ...
  it('should update input value on user typing', async () => {
    ...
    const amountInput = screen.getByLabelText(/amount/i) || screen.getByPlaceholderText(/amount/i) as HTMLInputElement;
